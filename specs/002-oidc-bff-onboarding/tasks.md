...
- [ ] T057 [P] Migrate the Next.js 16 route guard from `src/middleware.ts` to `src/proxy.ts`, update the feature plan, and remove the build deprecation warning. (Plan/runtime hygiene; partial)
